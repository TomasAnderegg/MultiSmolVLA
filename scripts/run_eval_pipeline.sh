...
# ── configure ────────────────────────────────────────────────────────────────
CHECKPOINT="/scratch/izar/$USER/checkpoints/stage3_joint/pipeline_step95000.pt"
TASK="libero_10"
N_EPISODES=5
OUTPUT_DIR="/home/garate/MultiSmolVLA/eval_results/multismolvla_${TASK}_stage3"
